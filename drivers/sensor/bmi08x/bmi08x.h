...
#if defined(CONFIG_BMI08X_ACCEL_RANGE_RUNTIME) || defined(CONFIG_BMI08X_ACCEL_RANGE_2G_3G)
#define BMI08X_DEFAULT_RANGE_ACC BMI08X_ACC_RANGE_2G_3G
#elif defined(CONFIG_BMI08X_ACCEL_RANGE_4G_6G)
#define BMI08X_DEFAULT_RANGE_ACC BMI08X_ACC_RANGE_4G_6G
#elif defined(CONFIG_BMI08X_ACCEL_RANGE_8G_12G)
#define BMI08X_DEFAULT_RANGE_ACC BMI08X_ACC_RANGE_8G_12G
#else
#define BMI08X_DEFAULT_RANGE_ACC BMI08X_ACC_RANGE_16G_24G
#endif

#if defined(CONFIG_BMI08X_GYRO_RANGE_RUNTIME) || defined(CONFIG_BMI08X_GYRO_RANGE_2000DPS)
#define BMI08X_DEFAULT_RANGE_GYR BMI08X_GYR_RANGE_2000DPS
#elif defined(CONFIG_BMI08X_GYRO_RANGE_1000DPS)
#define BMI08X_DEFAULT_RANGE_GYR BMI08X_GYR_RANGE_1000DPS
#elif defined(CONFIG_BMI08X_GYRO_RANGE_500DPS)
#define BMI08X_DEFAULT_RANGE_GYR BMI08X_GYR_RANGE_500DPS
#elif defined(CONFIG_BMI08X_GYRO_RANGE_250DPS)
#define BMI08X_DEFAULT_RANGE_GYR BMI08X_GYR_RANGE_250DPS
#else
#define BMI08X_DEFAULT_RANGE_GYR BMI08X_GYR_RANGE_125DPS
#endif

#if defined(CONFIG_BMI08X_ACCEL_ODR_RUNTIME) || defined(CONFIG_BMI08X_ACCEL_ODR_100)
#define BMI08X_DEFAULT_ODR_ACC 8
#elif defined(CONFIG_BMI08X_ACCEL_ODR_25_2)
#define BMI08X_DEFAULT_ODR_ACC 5
#elif defined(CONFIG_BMI08X_ACCEL_ODR_25)
#define BMI08X_DEFAULT_ODR_ACC 6
#elif defined(CONFIG_BMI08X_ACCEL_ODR_50)
#define BMI08X_DEFAULT_ODR_ACC 7
#elif defined(CONFIG_BMI08X_ACCEL_ODR_200)
#define BMI08X_DEFAULT_ODR_ACC 9
#elif defined(CONFIG_BMI08X_ACCEL_ODR_400)
#define BMI08X_DEFAULT_ODR_ACC 10
#elif defined(CONFIG_BMI08X_ACCEL_ODR_800)
#define BMI08X_DEFAULT_ODR_ACC 11
#else
#define BMI08X_DEFAULT_ODR_ACC 12
#endif

#if defined(CONFIG_BMI08X_GYRO_ODR_RUNTIME) || defined(CONFIG_BMI08X_GYRO_ODR_100_32)
#define BMI08X_DEFAULT_ODR_GYR 7
#elif defined(CONFIG_BMI08X_GYRO_ODR_200_64)
#define BMI08X_DEFAULT_ODR_GYR 6
#elif defined(CONFIG_BMI08X_GYRO_ODR_100_12)
#define BMI08X_DEFAULT_ODR_GYR 5
#elif defined(CONFIG_BMI08X_GYRO_ODR_200_23)
#define BMI08X_DEFAULT_ODR_GYR 4
#elif defined(CONFIG_BMI08X_GYRO_ODR_400_47)
#define BMI08X_DEFAULT_ODR_GYR 3
#elif defined(CONFIG_BMI08X_GYRO_ODR_1000_116)
#define BMI08X_DEFAULT_ODR_GYR 2
#elif defined(CONFIG_BMI08X_GYRO_ODR_2000_230)
#define BMI08X_DEFAULT_ODR_GYR 1
#else
#define BMI08X_DEFAULT_ODR_GYR 0
#endif
...
#endif
#if DT_ANY_INST_ON_BUS_STATUS_OKAY(i2c) || DT_ANY_INST_ON_BUS_STATUS_OKAY(i3c)
