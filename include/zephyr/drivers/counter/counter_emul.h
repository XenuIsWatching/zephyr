...
#ifndef ZEPHYR_INCLUDE_DRIVERS_COUNTER_COUNTER_EMUL_H_
#define ZEPHYR_INCLUDE_DRIVERS_COUNTER_COUNTER_EMUL_H_
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_COUNTER_COUNTER_EMUL_H_ */
