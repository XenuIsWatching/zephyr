...
#ifndef ZEPHYR_INCLUDE_DEVICETREE_COUNTER_H_
#define ZEPHYR_INCLUDE_DEVICETREE_COUNTER_H_
 ...
 *     DT_COUNTER_CAPTURES_CELL_BY_NAME(DT_NODELABEL(n), alpha, flags)   // COUNTER_CAPTURE_RISING_EDGE
 *     DT_COUNTER_CAPTURES_CELL_BY_NAME(DT_NODELABEL(n), beta, flags)    // COUNTER_CAPTURE_BOTH_EDGES
 *
 * @param node_id node identifier
 * @param counter_capture_pha lowercase-and-underscores counter capture
 *        property with type "phandle-array"
...
#endif  /* ZEPHYR_INCLUDE_DEVICETREE_COUNTER_H_ */
